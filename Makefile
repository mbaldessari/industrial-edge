...
vault-init:
	common/scripts/vault-utils.sh vault_init common/vault.init
	common/scripts/vault-utils.sh vault_unseal common/vault.init
	common/scripts/vault-utils.sh vault_secrets_init common/vault.init
